...
blue = (0, 0, 255)
yellow = (255, 255, 0)
background_color = (135, 206, 235)  # Светло-голубой цвет
...
def gameLoop():
    show_controls_message()  # Показываем инструкции перед началом игры
    ...
    # Список для хранения частей змейки и еды
    snake_List = []
    Length_of_snake = 1

    # Позиция еды (начальная)
    food_list = [Food()]  # Изначально одна еда
    ...
    while not game_over:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                # Добавляем возможность выхода из игры при нажатии Q во время игры.
                if event.key == pygame.K_q:
                    game_over = True
        ...
        if not game_paused:
            ...
            # Генерация новой еды каждые 5 секунд (синие и зеленые)
            ...
            for food in food_list:
                ...
                # Проверка на столкновение со змеёй.
                if x1 == food.x and y1 == food.y:
                    ...
                    food_list.remove(food)  # Удаляем съеденную еду
...
# Добавить возможность регистрации, а также статистику игроков
